...
<html>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="<?php Utils::indexTheme('/assets/bundle-e9f72d6d34.css');?>">
    <link rel="stylesheet" href="<?php Utils::indexTheme('/assets/VOID-601a771f36.css');?>">
    ...
    <style>div[itemprop=articleBody], .yue {
        font-family: 'Droid Serif', 'Noto Serif SC', 
